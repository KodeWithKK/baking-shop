...
function WishlistModal() {
  const { isWishlistModalOpen, toggleWishlistModal } = useAppContext();
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="mx-5 mt-4 space-y-1 overflow-hidden rounded-md bg-white p-1">
          <WishlistItem />
          <WishlistItem />
          <WishlistItem />
          <WishlistItem />
...
function WishlistItem() {
  return (
    <Link
      href="/"
      className="group flex w-full items-center gap-2 rounded-md p-2 text-left hover:bg-orange-600/20"
    >
      <img
